    ...
    groups: [
      {
        ...
        additions: [
          ...
          {
            zh: "Real 布局页顶栏显示阳光碎片数量（演示占位，待游戏数据同步）；图标与游戏一致，配色 rgb(255, 170, 127)。",
            en: "Real layout pages show Sunshard balance at the top (demo placeholder until game sync); icon matches in-game art at rgb(255, 170, 127).",
          },
        ],
      },
    ],
