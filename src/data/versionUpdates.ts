    ...
    groups: [
      {
        ...
        additions: [
          ...
          {
            zh: "私人租用挑战可在详情页显示当日站序（与普通线路相同的站序表、分区与报站音）；已录入 6/9、6/12、6/15、7/7 PH 站序。",
            en: "Private hire challenges can show the day’s stop order in detail (same stop table, zones, and PA as regular routes); 6/9, 6/12, 6/15, and 7/7 PH stops recorded.",
          },
        ],
      },
    ],
